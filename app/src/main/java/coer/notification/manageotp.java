                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        ...
                                        if(task.isSuccessful()){
                                            ...
                                            if (creationTimestamp == lastSignInTimestamp) {
                                                Intent intent = new Intent(getApplicationContext(), logindetailswithmobile.class);
                                            ...
                                            Toast.makeText(coer.notification.manageotp.this, "Enter The Correct OTP", Toast.LENGTH_SHORT).show();

                                        }
                                    }
                                });
                    }else{
                        Toast.makeText(coer.notification.manageotp.this, "Please Check Internet Connection", Toast.LENGTH_SHORT).show();
                    }
                    Toast.makeText(coer.notification.manageotp.this, "Verifying OTP", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(coer.notification.manageotp.this, "Please Enter All Numbers", Toast.LENGTH_SHORT).show();
            ...
            public void onClick(View v) {
                ...
                new CountDownTimer(60000, 1000) {
                    ...
                    PhoneAuthProvider.getInstance().verifyPhoneNumber(
                            ...
                            60,
                            TimeUnit.SECONDS,
                            coer.notification.manageotp.this,
                            new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                                ...
                                public void onVerificationFailed(@NonNull FirebaseException e) {
                                    Toast.makeText(coer.notification.manageotp.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                ...
                                public void onCodeSent(@NonNull String Newbackendotp, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                    ...
                                    resend.setTextColor(Color.BLACK);
                                    Toast.makeText(coer.notification.manageotp.this, "OTP Sent Succussfully", Toast.LENGTH_SHORT).show();
